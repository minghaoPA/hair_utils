...
#include <algorithm>
#include <string>
#include "trimesh2/include/Vec.h"
#include "trimesh2/include/XForm.h"
#include "Hair.h"
#include "strutil.h"
using namespace std;
...
int main(){
    Hair hair;
    const char* filename = "../data/hairstyles/strands00001.data";
    bool ret = hair.read(filename, false);
    cout << ret << endl;
    const char* filename_save = "../data/00001.txt";
    bool ret1 = hair.write(filename_save, false);
    cout << ret1 <<endl;
    return 0;
}
